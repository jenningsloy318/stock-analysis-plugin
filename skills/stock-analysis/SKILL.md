...
12. Run `${PLUGIN_SCRIPTS}/calculate_metrics.py ./reports/[TICKER]/raw-data.json --output ./reports/[TICKER]/metrics.json` to compute ratios and valuation. If market cap is known, add `--market-cap [VALUE]`.
