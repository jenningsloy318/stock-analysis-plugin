...
- Tool call log must be written to `./reports/[TICKER]/audit_log.json`
...
**Post-delivery:** Run `${PLUGIN_ROOT}/scripts/audit_tool_calls.py ./reports/[TICKER]/audit_log.json --min-calls 3` to verify grounding. If audit fails, add the INCOMPLETE flag to the report.
